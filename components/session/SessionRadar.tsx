...
export const SessionRadar: React.FC<SessionRadarProps> = ({ factors }) => {
 ...
 return (
 <div className="flex flex-col items-center justify-center h-full border border-[var(--border-primary)] rounded-lg bg-[var(--bg-primary)]/50 p-8 text-center">
 <div className="mb-2">
 ...
 {/* Legend / Info Overlay */}
 <div className="absolute top-0 right-0 p-2 text-[10px] font-mono text-[var(--text-secondary)] bg-[var(--card-bg)] shadow-sm rounded border border-[var(--border-primary)]">
 SIGNATURE_V1
 </div>
 </div>
 ...
 <span className="text-[9px] font-mono text-[var(--text-secondary)]"><CountUp value={data[i] * 10} decimals={1} /></span>
 </div>
 ))}
 </div>
 </div>

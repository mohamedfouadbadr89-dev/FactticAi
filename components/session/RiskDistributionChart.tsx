...
export const RiskDistributionChart: React.FC<RiskDistributionChartProps> = ({ turns }) => {
  ...
  return (
    <div className="w-full">
        ...
        {turns.map((turn, i) => {
          ...
          return (
            <div key={i} className="flex-1 flex flex-col justify-end group transition-opacity">
              {/* Tooltip-like value */}
              <div className="opacity-0 group-hover:opacity-100 transition-opacity text-[8px] font-mono text-zinc-400 text-center mb-1">
              ...
              <div className="mt-2 h-[1px] bg-zinc-800 w-full" />
              <div className="text-[8px] font-mono text-zinc-600 text-center mt-1">
                T{turn.turn_index}
              </div>
            </div>
          );
      ...
      <div className="mt-6 flex justify-between items-center text-[9px] font-mono text-zinc-500 uppercase tracking-widest border-t border-zinc-900 pt-4">
